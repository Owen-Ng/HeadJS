...
function examples() {
	const head = new Head([200,500], 100, "/img.JPG",100, true, "duplicating ");
	 ...
	 head.addclicklist({'Screen1.html':['Screen1', 'how are you', 'OKKKKKK',
	  ...
	  'link Screen2.html Screen2','link Screen1.html Screen1'],}, 100,20, 'white', 'coloring orange');
	 head.addoubleclick(['Screen1.html', 'Screen2.html', 'Screen3.html']);
	  head.addtouchhold({'Screen3.html':['top', 'down', 'rightttt', 'lefttttttttttttt']},'','', 'white', 'coloring orange') 
